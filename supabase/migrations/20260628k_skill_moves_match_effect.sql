-- Phase 5 (cont): skill_moves flair affects league attack/wing/central (±1.5%/star).
...
AS $function$
  ...
  -- Skill moves (1-5) flair: ±1.5% per star off the 3-star baseline, averaged over the XI.
  skill as (
