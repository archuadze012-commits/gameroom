-- Fix: opponent set-piece attack double-counted open-play lanes and let the
-- defence rating inflate attacking set-piece threat. Peg the synthetic
-- opponent set-piece attack to its overall base instead.
