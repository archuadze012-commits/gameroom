...
export function OnboardingChecklist({ hasProfile, hasGames, hasFollows, hasPush, hasClaimedDaily, isAdmin }: Props) {
  ...
  const steps: Step[] = [
    ...
    { key: "follow", done: srv(hasFollows), icon: UserPlus, label: "გაჰყევი 3 მოთამაშეს", spot: [{ sel: "nav-search", label: "ძებნა — იპოვე მოთამაშეები" }, { sel: "search-mobile", label: "გახსენი მეტი, აირჩიე ძებნა" }, { sel: "more-mobile", label: "გახსენი მეტი, აირჩიე ძებნა" }], href: "/search", cta: "პოვნა" },
