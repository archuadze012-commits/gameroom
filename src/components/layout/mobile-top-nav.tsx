...
export function MobileTopNav() {
  ...
  return (
    <>
      {/* bottom nav bar */}
      <div className="landscape:hidden fixed bottom-1 left-1 right-1 z-50 md:hidden">
      ...
      {moreOpen && (
        <div
          ref={sheetRef}
          className="landscape:hidden fixed bottom-[5.75rem] left-3 right-3 z-50 overflow-hidden rounded-[30px] border border-[rgba(236,72,153,0.25)] bg-[linear-gradient(145deg,rgba(13,9,27,0.95),rgba(5,4,12,0.98))] shadow-[0_26px_76px_rgba(0,0,0,0.75),0_0_34px_rgba(236,72,153,0.15)] backdrop-blur-3xl sm:hidden"
        >
          {/* Profile header */}
          {profile ? (
