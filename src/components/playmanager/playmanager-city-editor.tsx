...
import type { ClubEffectsSummary } from '@/lib/playmanager/progression';
...
import {
  ...
  BUILDING_PAGES,
  MEDIA_ITEMS,
  PRIMARY_ACTION_BY_FACILITY,
  TRAINING_SLOTS,
  fmtInt,
  getDevelopmentXpCost,
  getFacilityEffectText,
...
} from './city-editor-data';

// Re-exported so existing consumers keep importing these from this module.
export {
  DEFAULT_FACILITY_STATE,
  getDevelopmentXpCost,
  getPlayerPotentialForTraining,
  getTrainingGrowthCap,
  mergeFacilityState,
} from './city-editor-data';
export type {
  EditableCityBuilding,
  PlayerActionError,
  RunCityActionError,
} from './city-editor-data';
...
function getModulePhoto(moduleKey: string) {
  const map: Record<string, { src: string; position: string }> = {
    ...
    shortlist: { src: '/playmanager/city/buildings/gamestore.webp', position: '40% 58%' },
    scouting: { src: '/playmanager/city/buildings/gamestore.webp', position: '56% 40%' },
    outgoing: { src: '/playmanager/city/buildings/gamestore.webp', position: '72% 58%' },
    ...
    history: { src: '/playmanager/city/buildings/trophy_hall.webp', position: '34% 58%' },
    head_to_head: { src: '/playmanager/city/buildings/trophy_hall.webp', position: '70% 42%' },
    budget: { src: '/playmanager/city/buildings/headquarters.webp', position: '48% 50%' },
    sponsors: { src: '/playmanager/city/buildings/headquarters.webp', position: '60% 46%' },
    wages: { src: '/playmanager/city/buildings/headquarters.webp', position: '38% 58%' },
    ...
    missions: { src: '/playmanager/city/buildings/fountain.webp', position: '52% 52%' },
    daily_reward: { src: '/playmanager/city/buildings/fountain.webp', position: '38% 60%' },
    news: { src: '/playmanager/city/buildings/fountain.webp', position: '64% 42%' },
    reputation: { src: '/playmanager/city/buildings/fountain.webp', position: '50% 66%' },
    capacity: { src: '/playmanager/city/buildings/tower.webp', position: '50% 52%' },
    hotel: { src: '/playmanager/city/buildings/tower.webp', position: '38% 58%' },
    staff: { src: '/playmanager/city/buildings/tower.webp', position: '64% 46%' },
  ...
  return map[moduleKey] ?? { src: '/playmanager/iso/environment-sm.webp', position: '50% 50%' };
}
