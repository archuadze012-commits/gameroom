  ...
  return (
    <div className="relative h-48 sm:h-64 w-full overflow-hidden">
      ...
      <div className="absolute bottom-4 left-4 right-4 sm:bottom-5 sm:left-5 sm:right-5 z-20 flex flex-col justify-end">
        <h3
          className="font-display text-[16px] sm:text-[22px] font-black uppercase tracking-wide text-white drop-shadow-md transition-colors duration-300 group-hover:text-red-300 group-hover:drop-shadow-[0_0_15px_rgba(239,68,68,0.5)]"
        >
          {game.nameKa}
        </h3>
      </div>
