  ...
  return (
    <div className="relative min-h-[calc(100vh-4rem)] bg-[#05050f]">
      ...
      <div className="container relative mx-auto max-w-6xl px-4 py-8 lg:py-10">
        ...
        {/* Header */}
        <header className="mb-10 group relative rounded-[24px] p-[1.5px] bg-gradient-to-br from-[#00d0ff] via-[#6366f1] to-[#f43f5e] transition-shadow duration-500 hover:shadow-[0_0_40px_rgba(99,102,241,0.25)]">
          <div className="relative h-full w-full overflow-hidden rounded-[22.5px] bg-[#0a0714] p-5 sm:p-6 shadow-[inset_0_0_30px_rgba(139,92,246,0.05)] backdrop-blur-md">
            ...
            <div
              aria-hidden
              className="relative mt-6 h-px w-full bg-[linear-gradient(90deg,transparent,rgba(99,102,241,0.5),rgba(236,72,153,0.5),transparent)]"
            />
          </div>
        </header>

        {featuredBox && (
          <section className="mb-12 group relative rounded-[24px] p-[1.5px] bg-gradient-to-br from-[#00d0ff] via-[#6366f1] to-[#f43f5e] transition-shadow duration-500 hover:shadow-[0_0_50px_rgba(99,102,241,0.3)]">
            <div className="relative grid overflow-hidden rounded-[22.5px] bg-[#0a0714] lg:grid-cols-[1.35fr_0.65fr]">
              ...
              >
                <div className="relative z-[2] flex flex-wrap gap-2">
                  <span className="rounded-full border border-pink-500/50 bg-pink-500/20 px-4 py-1.5 text-[11px] font-black uppercase tracking-[0.16em] text-pink-300 shadow-[0_0_15px_rgba(236,72,153,0.3)] backdrop-blur-md">
                    Mythic
                  </span>
                  <span className="rounded-full border border-cyan-500/30 bg-cyan-500/10 px-4 py-1.5 text-[11px] font-black uppercase tracking-[0.16em] text-cyan-400 backdrop-blur-md">
                    Icefire
                  </span>
                  <span className="rounded-full border border-violet-500/30 bg-violet-500/10 px-4 py-1.5 text-[11px] font-black uppercase tracking-[0.16em] text-violet-400 backdrop-blur-md">
                    Caucasus
                  </span>
                </div>
              ...
              <aside className="relative z-[2] flex flex-col justify-center border-t border-white/5 bg-black/40 p-6 sm:p-8 lg:border-l lg:border-t-0">
                ...
                <p className="text-[11px] font-black uppercase tracking-[0.24em] text-pink-400 drop-shadow-[0_0_5px_rgba(236,72,153,0.5)]">
                  Featured item
                </p>
                ...
                <p className="mt-4 text-[14px] font-medium leading-relaxed text-white/60">
                  {featuredBox.description || "Premium crate showcase with ice blue frame, restrained gold economy cues, and high-value item presentation."}
                </p>
                ...
                <div className="flex flex-wrap items-end justify-between gap-4">
                  <div>
                    <p className="mb-1 text-[10px] font-black uppercase tracking-[0.2em] text-white/40">Open price</p>
