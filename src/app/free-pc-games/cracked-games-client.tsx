...
import { type CrackedGame } from "@/lib/mock-data";
...
export function CrackedGamesClient({ games }: { games: CrackedGame[] }) {
  ...
  const filtered = useMemo(() => {
    if (activeGenre === "ყველა") return games;
