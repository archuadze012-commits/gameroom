...
export const mockUsers: MockUser[] = [
  ...
  {
    username: "GeoSniper",
    displayName: "Geo Sniper",
    region: "GE",
    games: [{ slug: "pubg-mobile", rank: "Crown II" }, { slug: "warzone", rank: "Platinum" }],
    mainGameSlug: "pubg-mobile",
    voiceChat: true,
    bio: "PUBG-ის მოყვარული, squad ვეძებ ranked-ისთვის.",
    role: "streamer",
  },
  {
    username: "Sage_Tbilisi",
    displayName: "Sage Tbilisi",
    region: "GE",
    games: [{ slug: "valorant", rank: "Diamond II" }],
    mainGameSlug: "valorant",
    voiceChat: true,
    bio: "Valorant Premier team-ის კაპიტანი.",
    role: "moderator",
  },
  {
    username: "Lasha10",
    displayName: "Lasha",
    region: "GE",
    games: [{ slug: "efootball-mobile", rank: "Top 500" }, { slug: "fifa-mobile", rank: "Div 2" }],
    mainGameSlug: "efootball-mobile",
    voiceChat: false,
    bio: "eFootball co-op ივენთები.",
    role: "organizer",
  },
  {
    username: "El_Pippo",
    displayName: "El Pippo",
    region: "GE",
    games: [{ slug: "fifa-mobile", rank: "Div 1" }],
    mainGameSlug: "fifa-mobile",
    voiceChat: true,
    bio: "VS Attack Top 100 მიზანი.",
  },
  {
    username: "ZeroKD",
    displayName: "Zero KD",
    region: "GE",
    games: [{ slug: "warzone", rank: "Gold" }, { slug: "pubg-mobile", rank: "Platinum" }],
    mainGameSlug: "warzone",
    voiceChat: false,
    bio: "Chill გეიმინგი, სტრესი არ მინდა.",
  },
  {
    username: "Lika",
    displayName: "Lika",
    region: "EU",
    games: [{ slug: "valorant", rank: "Diamond I" }],
    mainGameSlug: "valorant",
    voiceChat: true,
    bio: "Sage one-trick, Premier-ში ვარ.",
  },
  {
    username: "Saba",
    displayName: "Saba",
    region: "GE",
    games: [{ slug: "pubg-mobile", rank: "Ace" }],
    mainGameSlug: "pubg-mobile",
    voiceChat: true,
  },
  {
    ...
    displayName: "Nika",
    region: "GE",
    games: [{ slug: "efootball-mobile", rank: "Top 100" }, { slug: "valorant", rank: "Platinum" }],
    mainGameSlug: "efootball-mobile",
    voiceChat: false,
  },
];
